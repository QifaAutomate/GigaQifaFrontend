export const translations = {
  zh: {
    ...
    chat_welcome: "你好！我是您的 AI 代理网络。今天我能为您做些什么？您可以通过点击下方の图标上传文件提供上下文。",
    ...
    contacts_in_work: "联系人在工作中",
    warm_leads: "热点潜在客户",
    processed_contacts_short: "已处理",
    contacts_in_work_short: "进行中",
    warm_leads_short: "热点",
    total_metrics: "总体指标",
  ...
  ru: {
    ...
    processed_contacts_short: "Обр.Контакты",
    contacts_in_work_short: "В работе",
    warm_leads_short: "Тёплые",
