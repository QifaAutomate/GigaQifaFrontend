...
const translations = {
  en: {
    ...
    header_title: "AgentConnect Console",
    ...
    chat_disclaimer: "AgentConnect Console can analyze complex documents using advanced AI agents.",
  ...
  ru: {
    ...
    agent_status: "АКТИВНОСТЬ АГЕНТОВ",
    analyst_agent: "Консультант",
    data_harvester: "Сборщик данных",
    validation_expert: "Эксперт по валидации",
    online: "В сети",
    idle: "Ожидание",
    thinking: "Думает...",
    searching: "Поиск данных...",
    validating: "Проверка...",
    header_title: "AgentConnect Console",
    ...
    chat_disclaimer: "AgentConnect Console может анализировать сложные документы с помощью продвинутых ИИ-агентов.",
